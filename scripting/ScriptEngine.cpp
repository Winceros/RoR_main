...
//=================================================
	result = engine->RegisterObjectMethod("BeamClass", "bool getAPmode()", AngelScript::asMETHOD(Beam,getAPmode), AngelScript::asCALL_THISCALL); MYASSERT(result>=0);
	result = engine->RegisterObjectMethod("BeamClass", "void steer(float)", AngelScript::asMETHOD(Beam,steer), AngelScript::asCALL_THISCALL); MYASSERT(result>=0);
	result = engine->RegisterObjectMethod("BeamClass", "void accel(float)", AngelScript::asMETHOD(Beam,accel), AngelScript::asCALL_THISCALL); MYASSERT(result>=0);
//=================================================	
	/*
